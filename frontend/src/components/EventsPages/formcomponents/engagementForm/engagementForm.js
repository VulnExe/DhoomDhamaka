              ...
              <div class="row g-0">
                ...
                <div class="col-xl-6">
                  <div class="card-body bg-indigo p-md-5 text-dark fw-bolder rounded">
                    ...
                    <div class="row">
                      <h4 className="fw-bold mb-4">Other Services :</h4>
                      <div class="col-md-4 mb-4">
                        <div class="form-check">
                          <input
                            class="form-check-input"
                      ...
                      <div class="col-md-4 mb-4">
                        <div class="form-check">
                          <input
                            ...
                            checked={checkedCatering}
                            onChange={() => {
                              setCheckedCatering(!checkedCatering);
                            }}
                          />
                          <label
                            class="form-check-label"
                    ...
                    {checkedPhotography && (
                      <div class="row">
                        <h4 className="fw-bold mb-3">PhotoGraphy :</h4>
                        <div class="col-md-4 mb-4">
                          <div class="form-check">
                            <input
                              class="form-check-input"
                              ...
                              id="CandidPic"
                            />
                            <label class="form-check-label" for="CandidPic">
                              Candid
                            </label>
                          </div>
                        </div>
                        ...
                        <div class="col-md-4 mb-4">
                          <div class="form-check">
                            <input
                              ...
                              id="CinematographyPic"
                            />
                            <label
                              class="form-check-label"
                              for="CinematographyPic"
                            >
                              Cinematography
                            </label>
                          </div>
                        ...
                        <div class="col-md-4 mb-4">
                          <div class="form-check">
                            <input
                              ...
                              id="DronePic"
                            />
                            <label class="form-check-label" for="DronePic">
                              Drone
                            </label>
                          </div>
                        </div>
                      ...
                      // <div>
                      //   <h4 className="fw-bold mb-3">Other Services :</h4>
                      //   <div class="col-md-4 mb-4">
                      //     <div class="form-check">
                      //       <input
                    ...
                    {checkedDecoration && (
                      <div class="row">
                        <h4 className="fw-bold mb-3 text-danger">Decoration :</h4>
                        <div class="col-md-4 mb-4">
                          <div class="form-check">
                            <input
                              class="form-check-input"
                              ...
                              id="RealFlower"
                            />
                            <label class="form-check-label" for="RealFlower">
                              Real Flower
                            </label>
                          </div>
                        </div>
                    ...
                    {checkedCatering && (
                      <div class="row">
                        <h4 className="fw-bold mb-3">Catering :</h4>
                        <div class="col-md-4 mb-4">
                          <div class="form-check">
                            <input
                              class="form-check-input"
